		...
		<div class="main" role="main">
			...
			<section class="slider-holder">
				<div class="flexslider carousel">
					<ul class="slides">
						<li>
							<img src="{{url('frontend/images/samples/slide1.jpg')}}" alt="" />
						</li>
						<li>
							<img src="{{url('frontend/images/samples/slide2.jpg')}}" alt="" />
						</li>
						<li>
							<img src="{{url('frontend/images/samples/slide3.jpg')}}" alt="" />
						</li>
					</ul>
					...
					<div class="job_listings">
						<ul class="job_listings">
							...
							<li class="job_listing">
								<a href="#">
									<div class="job_img">
										<img src="{{url('images/samples/person4.jpg')}}" alt="" class="company_logo">
									</div>
									<div class="position">
										<h3>White &amp; Sons</h3>
										<div class="company">
							...
							<li class="job_listing">
								<a href="#">
									<div class="job_img">
										<img src="{{url('backendimages/samples/person5.jpg')}}" alt="" class="company_logo">
									</div>
									<div class="position">
							...
							<li class="job_listing">
								<a href="#">
									<div class="job_img">
										<img src="{{url('backendimages/samples/person6.jpg')}}" alt="" class="company_logo">
									</div>
									<div class="position">
