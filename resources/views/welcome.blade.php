					...
					<div class="header-top-right">
						...
						<div class="menu-container">
							<ul class="header-top-nav header-top-nav__tertiary">
								<li><a href="{{url('client/register')}}"><i class="fa fa-user-plus"></i> Register</a></li>
								<li><a href="{{url('client/login')}}"><i class="fa fa-sign-in"></i> Login</a></li>
							</ul>
						</div>
					</div>
				</div>
		...
		<div class="main" role="main">
			...
			<section class="slider-holder">
				...
				<div class="flexslider carousel">
					<ul class="slides">
						<li>
							<img src="{{('frontend/images/samples/slider1.jpg')}}" alt="" />
						</li>
						<li>
							<img src="{{url('frontend/images/samples/slider2.jpg')}}" alt="" />
						</li>
						<li>
							<img src="{{url('frontend/images/samples/slider3.jpg')}}" alt="" />
						</li>
					</ul>
					...
					<div class="job_listings">
						<ul class="job_listings">
							<li class="job_listing">
								<a href="#">
									<div class="job_img">
										<img src="{{url('frontend/images/samples/person1.jpg')}}" alt="" class="company_logo">
									</div>
									<div class="position">
										<h3>Debbie Bidart</h3>
										<div class="company">
							...
							<li class="job_listing">
								<a href="#">
									<div class="job_img">
										<img src="{{url('frontend/images/samples/person2.jpg')}}" alt="" class="company_logo">
									</div>
									<div class="position">
							...
							<li class="job_listing job_position_featured">
								<a href="#">
									<div class="job_img">
										<img src="{{url('frontend/images/samples/person3.jpg')}}" alt="" class="company_logo">
									</div>
									<div class="position">
							...
							<li class="job_listing">
								<a href="#">
									<div class="job_img">
										<img src="{{url('frontend/images/samples/person4.jpg')}}" alt="" class="company_logo">
									</div>
									<div class="position">
										<h3>White &amp; Sons</h3>
										<div class="company">
							...
							<li class="job_listing">
								<a href="#">
									<div class="job_img">
										<img src="{{url('frontend/images/samples/person5.jpg')}}" alt="" class="company_logo">
									</div>
									<div class="position">
							...
							<li class="job_listing">
								<a href="#">
									<div class="job_img">
										<img src="{{url('frontend/images/samples/person6.jpg')}}" alt="" class="company_logo">
									</div>
									<div class="position">
					...
					<div class="promobox" data-stellar-background-ratio="0.5">
						<div class="row">
							<div class="col-md-4 promobox-item">
								...
								<img src="{{url('frontend/images/samples/worker3.png')}}" alt="" class="img-responsive">
								<a href="#" class="btn btn-primary btn-sm">See Here</a>
							</div>
							<div class="col-md-4 promobox-item">
								<h4><span>For</span> Plumbers</h4>
								<img src="{{url('frontend/images/samples/worker1.png')}}" alt="" class="img-responsive">
								<a href="#" class="btn btn-primary btn-sm">See Here</a>
							</div>
							<div class="col-md-4 promobox-item">
								<h4><span>For</span> Builders</h4>
								<img src="{{url('frontend/images/samples/worker2.png')}}" alt="" class="img-responsive">
								<a href="#" class="btn btn-primary btn-sm">See Here</a>
							</div>
						</div>
					</div>
							...
							<div class="row">
								<div class="col-sm-3 col-md-3">
									<div class="text-center">
										<a href="#"><img src="{{url('frontend/images/samples/client-logo1-dark.png')}}" alt="" class="img-responsive"></a>
									</div>
								</div>
								<div class="col-sm-3 col-md-3">
									<div class="text-center">
										<a href="#"><img src="{{url('frontend/images/samples/client-logo2-dark.png')}}" alt="" class="img-responsive"></a>
									</div>
								</div>
								<div class="col-sm-3 col-md-3">
									<div class="text-center">
										<a href="#"><img src="{{url('frontend/images/samples/client-logo3-dark.png')}}" alt="" class="img-responsive"></a>
									</div>
								</div>
								<div class="col-sm-3 col-md-3">
									<div class="text-center">
										<a href="#"><img src="{{url('frontend/images/samples/client-logo4-dark.png')}}" alt="" class="img-responsive"></a>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="row">
							...
							<div class="testimonial">
								...
								<div class="bq-author">
									<figure class="author-img">
										<img src="{{url('frontend/images/samples/user1-sm.jpg')}}" alt="">
									</figure>
									<h6>Michael Smith</h6>
						...
						<div class="col-md-3">
							<div class="testimonial">
								...
								<div class="bq-author">
									<figure class="author-img">
										<img src="{{url('frontend/images/samples/user3-sm.jpg')}}" alt="">
									</figure>
						...
						<div class="col-md-3">
							<div class="testimonial">
								...
								<div class="bq-author">
									<figure class="author-img">
										<img src="{{url('frontend/images/samples/user2-sm.jpg')}}" alt="">
									</figure>
									<h6>Hanna Pinkman</h6>
						...
						<div class="col-md-3">
							<div class="testimonial">
								...
								<div class="bq-author">
									<figure class="author-img">
										<img src="{{url('frontend/images/samples/user4-sm.jpg')}}" alt="">
									</figure>
									<h6>Erick Fox</h6>
								...
								<div class="latest-posts-widget widget widget__footer">
									...
									<div class="widget-content">
										<ul class="latest-posts-list">
											<li>
												<figure class="thumbnail"><a href="#"><img src="{{url('frontend/images/samples/post-img1-sm.jpg')}}" alt=""></a></figure>
												<h5 class="title"><a href="#">Three Simple Household Repairs That'll Save You Hundreds</a></h5>
												<span class="date">April, 18 2015</span>
											</li>
											<li>
												<figure class="thumbnail"><a href="#"><img src="{{url('frontend/images/samples/post-img2-sm.jpg')}}" alt=""></a></figure>
												<h5 class="title"><a href="#">Tools That Make Yard Work Easy: The Big Backpack Blower</a></h5>
												<span class="date">March, 21 2015</span>
											</li>
											<li>
												<figure class="thumbnail"><a href="#"><img src="{{url('frontend/images/samples/post-img3-sm.jpg')}}" alt=""></a></figure>
